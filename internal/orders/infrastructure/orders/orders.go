...
func (repo *Repository) Save(ctx context.Context, order Order) error {
...
func (repo *Repository) GetByID(ctx context.Context, orderId uuid.UUID) (*Order, error) {
...
func (repo *Repository) GetByUserID(ctx context.Context, userId uuid.UUID) ([]*Order, error) {
	query, args, err := squirrel.Select("id", "user_id", "items", "status", "created_at").
		From(`"orders"`).
